...
const bulletText = '~~ヾ(ﾟ∀ﾟゞ)(ﾉﾟ▽ﾟ)ﾉ~~' // 独轮车弹幕
...
const checkIfCanSendDanmuku = () => {
  const $chatInputBox = el('.chat-input.border-box')
  const $sendButton = el('.bl-button.live-skin-highlight-button-bg.bl-button--primary.bl-button--small')
